...
return [
    ...
    'settings' => [
        ...
        'translation_workflow' => 'Flujo de traducción',
        'workflow_description' => 'Elige cómo pasa el contenido traducido desde la edición hasta su publicación.',
        ...
        'public_language_page' => 'Página pública de idiomas',
        'public_language_page_description' => 'Controla si los visitantes pueden abrir el selector de idiomas independiente de Ronove.',
        'public_language_page_help' => 'Al desactivarla, GET /ronove responde como página no encontrada. Ronove deja la navegación pública en manos del tema activo.',
        'public_language_page_endpoint_help' => 'Los selectores de los temas continúan usando POST /ronove/locale. Desactivar esta página nunca desactiva el cambio de idioma.',
        'enabled' => 'Activado',
        'disabled' => 'Desactivado',
        'always_active' => 'Siempre activo',
        'direct_mode' => 'Publicación directa',
        'direct_mode_help' => 'Los traductores autorizados pueden guardar borradores o publicar inmediatamente.',
        'review_mode' => 'Revisión obligatoria',
        'review_mode_help' => 'Los traductores envían cambios y un revisor autorizado aprueba la publicación.',
        ...
        'save_hint' => 'Guarda para aplicar estos ajustes de Ronove.',
        'updated' => 'Los ajustes de Ronove han sido actualizados.',
    ],
    'languages' => [
        'title' => 'Idiomas',
        'description' => 'Elige los idiomas de destino que Ronove traducirá a partir del contenido original de Azuriom.',
        'global' => 'Idioma original de Azuriom: :locale',
        'global_label' => 'Idioma del contenido original',
        'selected' => 'Idiomas de traducción',
        'available' => 'Destinos disponibles',
        'step_languages' => 'Paso 1',
        'step_fallbacks' => 'Paso 2',
        'available_title' => 'Idiomas de traducción',
        'available_description' => 'Habilita los idiomas de destino. El idioma global de Azuriom se omite porque ya corresponde al contenido original.',
        'search' => 'Buscar idiomas...',
        'no_search_results' => 'Ningún idioma coincide con la búsqueda.',
        'save_selection_help' => 'Al guardar se actualizarán las opciones de respaldo regional.',
        'flag' => 'Bandera del país',
        'flag_for' => 'Bandera del país para :locale',
        'flag_description' => 'Personaliza cada bandera con un código de país de dos letras como ES, MX, GB o US.',
        'fallbacks_save_help' => 'Los cambios de respaldo solo utilizan traducciones publicadas.',
        'updated' => 'Los idiomas disponibles han sido actualizados.',
        'fallbacks_title' => 'Respaldos regionales',
        'fallbacks_description' => 'Elige el siguiente idioma traducido que Ronove debe intentar antes de mostrar el contenido original de Azuriom.',
        'fallback_for' => 'Respaldo para :locale',
        'fallback_global' => 'Usar directamente el contenido original de Azuriom',
    ...
    'glossary' => [
        ...
        'add_description' => 'Define el término original, su traducción preferida y una guía opcional para los traductores.',
        'edit_title' => 'Editar término del glosario',
        'edit_description' => 'Actualiza la terminología preferida y su guía de uso.',
        'back' => 'Regresar al glosario',
        'terms' => 'Términos',
    ...
    'translations' => [
        ...
        'published' => 'La traducción ha sido guardada y publicada.',
    ...
    'audit' => [
        ...
        'report_eyebrow' => 'Resumen del diagnóstico',
        'report_title' => 'Estado actual de los datos',
        ...
        'healthy_eyebrow' => 'Todo en orden',
        'checked_areas' => 'Áreas comprobadas',
        'areas' => [
            'resources' => 'Recursos',
        ...
        'cleanup_guidance_title' => 'Revisa cada categoría antes de limpiar.',
        'finding_categories' => 'Categorías con hallazgos',
        'findings_count' => '{1} :count hallazgo en esta categoría.|[2,*] :count hallazgos en esta categoría.',
